...
static void increase_size(vector_t *v, size_t new_size) {
    if (v->size >= new_size) {
        return;
    }
...
/** Create a new vector with a size (length) of 1 and set its single component
   to zero... the right way */
