...
int main(int argc, char **argv) {
    ...
    printf(
        "Congrats! If you have made it to this line, your Part 1 Test cases "
        "are all passing!\n");
    ...
    strcpy(dna_seq_3.sequence, "ACGT");
    ...
    printf(
        "Congrats! If you have made it to this line, your Part 2 Test cases "
        "are all passing!\n");
