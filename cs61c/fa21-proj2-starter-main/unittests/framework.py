...
def run_raw_venus(check_calling_convention: bool = True, extra_flags: Optional[List[str]] = None,
                  args: Optional[List[str]] = None, verbose: bool = False):
...
def run_venus(filename: str, check_calling_convention: bool = True, extra_flags: Optional[List[str]] = None,
              args: Optional[List[str]] = None, verbose: bool = False):
...
class AssemblyTest:
    ...
    def __init__(self, test: unittest.TestCase, assembly: str, check_calling_convention: bool = True,
                 no_utils: bool = False):
    ...
    def input_array(self, register: str, value: ArrayData):
        ...
        assert isinstance(value,
                          ArrayData), f"{value} is a {type(value)}, expected an array (created with the array([..]) method!"
    ...
    def check_file_output(self, actual: str, expected: str):
        ...
        self._test.assertTrue(full_actual.is_file(),
