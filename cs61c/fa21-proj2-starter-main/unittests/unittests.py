...
SIMPLE0_ARGS = ["../inputs/simple0/bin/m0.bin", "../inputs/simple0/bin/m1.bin",
                "../inputs/simple0/bin/inputs/input2.bin"]
LARGER0_ARGS = ["../inputs/larger0/bin/m0.bin", "../inputs/larger0/bin/m1.bin",
                "../inputs/larger0/bin/inputs/input0.bin"]
MNIST10_ARGS = ["../inputs/mnist/bin/m0.bin", "../inputs/mnist/bin/m1.bin",
                "../inputs/mnist/bin/inputs/mnist_input10.bin"]
MNIST127_ARGS = ["../inputs/mnist/bin/m0.bin", "../inputs/mnist/bin/m1.bin",
                 "../inputs/mnist/bin/inputs/mnist_input127.bin"]
