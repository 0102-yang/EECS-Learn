...
class Application:
    ...
    def setupAlphaButtonAndLabel(self, win):
        ...
        self.alpha = self.sigmoid(self.al)
        self.alpha_label = tkinter.Label(win,
                                         text='Learning Rate: %.3f' %
                                         (self.alpha))
    ...
    def setUpGammaButtonAndLabel(self, win):
        ...
        self.gamma = self.sigmoid(self.ga)
        self.gamma_label = tkinter.Label(win,
    ...
    def setupEpsilonButtonAndLabel(self, win):
        ...
        self.epsilon = self.sigmoid(self.ep)
        self.epsilon_label = tkinter.Label(win,
                                           text='Epsilon: %.3f' %
                                           (self.epsilon))
    ...
    def setupSpeedButtonAndLabel(self, win):
        self.speed_minus = tkinter.Button(
            win, text="-", command=(lambda: self.incrementSpeed(.5)))
        self.speed_minus.grid(row=0, column=0)

        self.speed_label = tkinter.Label(win,
                                         text='Step Delay: %.5f' %
                                         (self.tickTime))
