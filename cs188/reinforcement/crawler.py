...
class CrawlingRobot:
    ...
    def moveArm(self, newArmAngle):
        ...
        disp = self.displacement(self.armAngle, self.handAngle, newArmAngle,
                                 self.handAngle)
...
#           self.angleSums.pop(0)
    ...
    def displacement(self, oldArmDegree, oldHandDegree, armDegree, handDegree):
        ...
        if y < 0:
            if yOld <= 0:
                return math.sqrt(xOld * xOld + yOld * yOld) - math.sqrt(x * x +
                                                                        y * y)
            return (xOld - yOld * (x - xOld) /
                    (y - yOld)) - math.sqrt(x * x + y * y)
        else:
            if yOld >= 0:
                return 0.0
            return -(x - y * (xOld - x) /
                     (yOld - y)) + math.sqrt(xOld * xOld + yOld * yOld)
...
#        self.lastVel = velocity
    ...
    def __init__(self, canvas):
        ...
        self.robotBody = canvas.create_polygon(0,
                                               0,
                                               0,
                                               0,
                                               0,
