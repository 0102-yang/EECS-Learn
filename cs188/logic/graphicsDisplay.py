...
class PacmanGraphics:
    ...
    def make_window(self, width, height):
        ...
        begin_graphics(screen_width, screen_height, BACKGROUND_COLOR, "Pacman")
    ...
    def colorCircleCells(self,
                         cells,
                         fillColor=PALE_PACMAN_COLOR,
                         direction="North",
    ...
    def colorCircleSquareCells(self,
                               pacman_cells,
                               square_cells=[],
                               circleColor=PALE_PACMAN_COLOR,
                               squareColor=formatColor(0.0, 0.0, 1.0),
                               direction="North",
                               pacman_position=None):
        endpoints = self.getEndpoints(direction)
