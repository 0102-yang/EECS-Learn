...
class Environment(object):
    ...
    def step(self):
        ...
        if not self.is_done():
            actions = [
                agent.program(self.percept(agent)) for agent in self.agents
            ]
...
class XYEnvironment(Environment):
    ...
    def percept(self, agent):
        ...
        return [
            self.thing_percept(thing, agent)
...
class VacuumEnvironment(XYEnvironment):
    ...
    def thing_classes(self):
        return [
            Wall, Dirt, ReflexVacuumAgent, RandomVacuumAgent,
    ...
    def percept(self, agent):
        ...
        status = if_(self.some_things_at(agent.location, Dirt), 'Dirty',
                     'Clean')
